    ...
    <div class="col-lg-12 col-md-12">
      ...
      <table class="items-list col-lg-12 col-md-12 table-hover">
        ...
        <tr class="item first rowid<?php echo $data['rowid'] ?>">
          ...
          <td class="price">INR <span class="price<?php echo $data['rowid'] ?>"><?php echo number_format($data['price']) ?></span></td>
          <td class="qnt-count">
            <input class="update_qty quantity qty<?php echo $data['rowid'] ?> form-control" p_id="<?php echo $data['rowid'] ?>" type="number" min="1" value="<?php echo $data['qty'] ?>">
            <!-- <span class="Update" onclick="javascript:updateproduct('<?php echo $data['rowid'] ?>')">Update</span> -->
          </td>
          <td class="total">INR <span class="subtotal subtotal<?php echo $data['rowid'] ?>"><?php echo number_format($data['subtotal']) ?></span></td>
      ...
      <div class="modal-footer">
        ...
        <a href="<?php echo site_url('welcome/billing_view') ?>"><button type="button" class="btn btn-primary place_order">Place Order</button></a>
      </div>
    </div>
  </div>
</div>
